export const CNBARawDataMocked: string = `3201903010000014200096206760174753****3153153453JOÃO MACEDO   BAR DO JOÃO       
...
export const CNABInformationMocked = [{
    registryType: '1',
    creditDate: '2019030',
    value: '000001520',
    CPF: '0962067601',
